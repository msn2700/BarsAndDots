...
class CROutput extends React.Component {
    ...
    getStations() {
        ...
        let station1 = getFirst819fromCR(parseInt(this.props.tzolkinCoefficient,10), 
                                        parseInt(this.props.tzolkinName,10), 
                                        parseInt(this.props.haabCoefficient,10), 
                                        parseInt(this.props.haabName,10));
        ...
        return (
            <Grid container>
                ...
                <Grid item xs={12} md={3}>{crString(lcdToCRInfo(station1), this.props.names)}</Grid>
                ...
                <Grid item xs={12} md={3}>{crString(lcdToCRInfo(station2), this.props.names)}</Grid>
    ...
    render() {
        ...
        return(
            <Grid container>
                <Grid item md={12}>{this.getStations()}</Grid>
                <Grid item md={12}>
...
//export default withStyles(styles)(CROutput);
export default CROutput;
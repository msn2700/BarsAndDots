...
class MayaLC extends React.Component {
    ...
    constructor(props) {
        ...
        let lc = getLCValues(getLCDFromJDN(changeToJDN(new Date().getDate(), new Date().getMonth() + 1, new Date().getFullYear(), 'g'), this.props.correlation));
    ...
    render() {
        ...
        return(
            ...
            <Grid container>
                ...
                <Grid item xs={4} md={6} sx={textboxStyleRight}></Grid>
                ...
                <Grid item xs={4} md={6} sx={textboxStyleLeft}></Grid>
